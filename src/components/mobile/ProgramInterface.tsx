...
const MobileNodeRenderer: FunctionComponent<MobileNodeRendererProps> = ({ node }) => {
  return <p>MobileNodeRenderer not available</p>;
...
export const InterfaceWrapper: FunctionComponent<InterfaceWrapperProps> = ({ children }) => {
