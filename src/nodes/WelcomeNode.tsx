...
export const WelcomeNodeContent: FunctionComponent<{}> = () => {
  ...
  return (
    <div className="flex flex-col gap-1 p-2">
      ...
      <p>
        I am Luna the bat, and this is Beadi, a platform for visual, node-based,
        programming for{" "}
        <a
      ...
      <p>
        ...
        forget to connect your toys or a server in the server tab on the right.
        You can delete this message, by selecting the node and pressing{" "}
        <code>Backspace</code>, and if you want to view it again, go to the File
        tab on the right, and discard your current File.
      </p>
